import{i as A,a2 as r,n as g,c as P,a as D,f as E,N as h,x as c,m as K,E as W,R as S,A as U,h as M,ad as F,g as Q,W as q,r as z,e as H,aG as j}from"./index-Dwafa-vz.js";import{S as n}from"./SwapController-CYGzAOZJ.js";import"./index-UemkDcH5.js";const G={numericInputKeyDown(u,e,t){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=u.metaKey||u.ctrlKey,o=u.key,a=o.toLocaleLowerCase(),l=a==="a",b=a==="c",I=a==="v",_=a==="x",L=o===",",O=o===".",B=o>="0"&&o<="9";!s&&(l||b||I||_)&&u.preventDefault(),e==="0"&&!L&&!O&&o==="0"&&u.preventDefault(),e==="0"&&B&&(t(o),u.preventDefault()),(L||O)&&(e||(t("0."),u.preventDefault()),(e!=null&&e.includes(".")||e!=null&&e.includes(","))&&u.preventDefault()),!B&&!i.includes(o)&&!O&&!L&&u.preventDefault()}},X=A`
  :host {
    width: 100%;
  }
